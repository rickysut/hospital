...
class AdminPanelProvider extends PanelProvider
{
    ...
    {
        $isTop = config('hospital.top_navigation', true);
        $settingSection = __('filament-spatie-roles-permissions::filament-spatie.section.roles_and_permissions');
        // dd(app()->getLocale(), $settingSection);    
        return $panel
            ->default()
            ->id('admin')
            ->path('')
